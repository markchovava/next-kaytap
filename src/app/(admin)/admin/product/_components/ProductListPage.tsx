  ...
  return (
    <>
      <div>
          ...
          <section className="w-full lg:overflow-hidden overflow-scroll">
            <div className='lg:w-[100%] w-[70rem]'>
              ...
              <section className="w-full bg-gray-300 font-bold text-lg border border-gray-400 flex items-center justify-start">
                ...
                <div className="flex-4 border-r border-gray-400 px-2 py-1">PRICE</div>
                <div className="flex-2 border-r border-gray-400 px-2 py-1">QUANTITY</div>
                <div className="flex-2 px-2 border-gray-400 py-1 text-end">ACTION</div>
              </section>

              {/* Data rows */}
              {ProductsData.map((i, key) => (
                <section key={key} className="w-full border-l border-r border-b border-gray-400 flex items-center justify-start">
                  ...
                  <div className="flex-4 border-r border-gray-400 px-2 py-3">${i.price}</div>
                  <div className="flex-2 border-r border-gray-400 px-2 py-3">{i.quantity}</div>
        ...
        <ProductAddModal isModal={isModal} setIsModal={setIsModal} />
      </div>
    </>
  )
}
