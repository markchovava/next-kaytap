...
export const AuthTokenCookieName = 'KAYTAP_AUTH_TOKEN_COOKIE'
export const UserCookieName = 'KAYTAP_CURRENT_USER_COOKIE'
export const BookingCookieName = 'KAYTAP_BOOKING_COOKIE'
